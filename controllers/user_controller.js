...
exports.loggedUserIsUser = function(req, res, next) {
   if (req.session.user && req.session.user.id == req.user.id) {
      ...
      console.log('Ruta prohibida: no eres el usuario logeado.');
      res.send(403);
   }
};
...
'<p>Por favor, confirma tu cuenta en este <a href="'+process.end.FRONTEND_URL+'/confirm?u='+user.id+'&k='+user.hashed_password+'" target="_blank">link</a></p>'+
'<p>Un saludo,<p>'+
